        ...
        <div className="space-y-8 md:w-1/2">
          <div className="space-y-4">
            ...
            <div className="space-y-6">
              <p className="text-lg leading-relaxed text-slate-700 sm:text-xl">
                At VEGO, we provide comprehensive charging solutions designed to meet a wide range of operational needs, from individual use to large fleets.
              </p>
              
              <p className="text-lg leading-relaxed text-slate-700 sm:text-xl">
                Our charging systems include three main methods:
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="rounded-2xl border-l-4 border-amber-500 bg-amber-50/50 p-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-slate-900">Home Charging</h3>
              </div>
              <p className="mt-3 text-slate-700">
                Safe and convenient charging from any standard electrical outlet, ideal for daily personal use.
              </p>
            </div>
            ...
            <div className="rounded-2xl border-l-4 border-emerald-500 bg-emerald-50/50 p-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-slate-900">Fast Charging</h3>
              </div>
              <p className="mt-3 text-slate-700">
                Advanced stations that deliver high-speed charging in record time.
              </p>
            </div>
            ...
            <div className="rounded-2xl border-l-4 border-blue-500 bg-blue-50/50 p-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-slate-900">Battery Swap</h3>
              </div>
              <p className="mt-3 text-slate-700">
                Innovative technology that allows replacing a depleted battery with a fully charged one in seconds, ensuring uninterrupted operation.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-gradient-to-br from-slate-50 to-white p-8 shadow-xl">
            <p className="text-center text-lg font-medium text-slate-800">
              VEGO&apos;s charging systems are designed to provide <span className="font-bold text-primary">flexibility</span>, <span className="font-bold text-primary">speed</span>, and <span className="font-bold text-primary">sustainability</span> for every journey.
            </p>
            
            {/* Stats */}
            <div className="mt-8 grid grid-cols-3 gap-6 border-t border-slate-200 pt-8">
              {[
                { value: "80%", label: "Faster Charging" },
