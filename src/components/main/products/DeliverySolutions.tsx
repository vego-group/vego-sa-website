        ...
        <div className="space-y-8 md:w-1/2">
          <div className="space-y-4">
            ...
            <div className="space-y-6">
              <p className="text-lg leading-relaxed text-slate-700 sm:text-xl">
                At VEGO, we provide an integrated ecosystem of intelligent delivery solutions designed to meet the needs of companies and delivery personnel with efficiency and sustainability.
              </p>
              
              <p className="text-lg leading-relaxed text-slate-700 sm:text-xl">
                From electric bicycles equipped with smart and refrigerated boxes, to fast charging systems and fleet management through the My VEGO platform—every element is designed to make delivery operations faster, more economical, and smarter.
              </p>
              
              <p className="text-lg leading-relaxed text-slate-700 sm:text-xl">
                Our solutions combine technology and sustainability to reduce operational costs and enhance service quality, supporting the transformation towards an eco-friendly delivery sector.
              </p>
            </div>
          </div>
          
          {/* Features List - Luxury Version */}
          <div className="rounded-3xl bg-gradient-to-br from-slate-50 to-white p-8 shadow-xl">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {[
                { title: "Real-time Fleet Tracking", icon: "📍" },
                { title: "Battery Management System", icon: "⚡" },
                { title: "Intelligent Analytics Dashboard", icon: "📊" },
                { title: "Multi-Device Compatibility", icon: "📱" },
                { title: "Sustainability Integration", icon: "🌱" }
              ].map((feature, index) => (
