...
type PrivacyPolicySectionCardProps = {
  section: PrivacyPolicySection;
};

export default function PrivacyPolicySectionCard({
  section,
  ...
  return (
    <motion.section
      ...
      className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-[0_20px_60px_-36px_rgba(15,23,42,0.35)] transition hover:-translate-y-1 hover:shadow-[0_28px_70px_-36px_rgba(13,22,63,0.4)] md:p-8"
    >
      <div className="mb-6">
      ...
      {section.description ? (
        <p className="mb-5 text-base leading-8 text-slate-600 md:text-lg">
          {section.description}
        </p>
      ) : null}
