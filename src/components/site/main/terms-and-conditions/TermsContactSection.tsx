...
import type { TermsContactContent } from "@/types";

type TermsContactSectionProps = {
  contact: TermsContactContent;
};

export default function TermsContactSection({
  contact,
}: TermsContactSectionProps) {
  return (
    <motion.section
      ...
      className="mt-8 overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-8 text-slate-900 shadow-[0_24px_80px_-32px_rgba(15,23,42,0.22)] md:p-10"
    >
