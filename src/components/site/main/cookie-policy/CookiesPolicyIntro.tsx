...
import type { CookiesPolicyIntroContent } from "@/interfaces/site/main/cookie-policy";

type CookiesPolicyIntroProps = {
  intro: CookiesPolicyIntroContent;
  isArabic: boolean;
};

export default function CookiesPolicyIntro({
  intro,
  isArabic,
}: CookiesPolicyIntroProps) {
  return (
    <motion.section
