...
type CookiePolicySectionCardProps = {
  section: CookiePolicySection;
};

function getToneClasses(tone: CookiePolicySection["tone"]) {
  if (tone === "secondary") {
    return {
...
export default function CookiePolicySectionCard({
  section,
}: CookiePolicySectionCardProps) {
