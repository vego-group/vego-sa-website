...
import { CookiesPolicyContactContent } from "@/interfaces/site/main/cookie-policy";

type CookiesPolicyContactProps = {
  contact: CookiesPolicyContactContent;
};

export default function CookiesPolicyContact({
  contact,
}: CookiesPolicyContactProps) {
  return (
    <motion.section
