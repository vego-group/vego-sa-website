    ...
    <div className="fixed inset-0 z-[60] lg:hidden">
      <div className="flex min-h-full flex-col border-l border-white/20  bg-primary px-6 pb-10 pt-3 shadow-2xl shadow-primary/20 backdrop-blur-xl">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/30 bg-white/15 text-white shadow-sm transition hover:bg-white/25"
