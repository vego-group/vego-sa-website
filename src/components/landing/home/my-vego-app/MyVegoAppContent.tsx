...
function MyVegoAppContent({
  content,
}: MyVegoAppContentProps): ReactElement {
  return (
    <div className="flex flex-col items-center text-center [direction:rtl] lg:items-end lg:text-end">
      ...
      <p className="mt-7 max-w-xl text-sm font-light leading-7 text-white/62 sm:text-base sm:leading-8">
        {content.description}
      </p>
