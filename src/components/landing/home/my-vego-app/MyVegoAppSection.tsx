...
function MyVegoAppSection(): ReactElement {
  return (
    ...
    >
      ...
      <div className="ms-auto me-auto grid w-full max-w-7xl items-center gap-12 [direction:ltr] lg:grid-cols-[minmax(0,0.85fr)_minmax(31rem,1.15fr)] lg:gap-16 xl:gap-20">
