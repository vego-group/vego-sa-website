  ...
  const [leads, setLeads] = useState<Lead[]>([
    {
      ...
      message:
        "We are interested in implementing an ERP solution for our manufacturing business. Could you provide information about your ERP system, pricing, and implementation timeline? We have 200+ employees and need a scalable solution.",
      date: "Feb 9, 2025",
      category: "Products",
    },
    {
      ...
      message:
        "Looking for a cloud-based ERP solution for our growing startup. What modules do you offer for small businesses? We're particularly interested in finance and HR modules.",
      date: "Feb 8, 2025",
    ...
    },
    {
      ...
      message:
        "We need ERP implementation support for our Dubai office. Do you provide training and ongoing support? We're specifically looking for Arabic language support.",
      date: "Feb 7, 2025",
      category: "Support",
    },
  ]);
          ...
          >
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <span
                  className={`inline-flex mt-1 px-2 py-1 text-xs rounded-full font-medium ${getCategoryColor(lead.category)}`}
                >
          ...
          {filteredLeads.map((lead) => (
            ...
            >
              ...
              <div className="col-span-1">
                <span className="text-sm text-white/60">{lead.date}</span>
              </div>

              {/* Category */}
              <div className="col-span-2">
                <span
                  className={`inline-flex px-3 py-1.5 text-xs rounded-full font-medium ${getCategoryColor(lead.category)}`}
                >
                  {lead.category || "Not specified"}
                </span>
              </div>
