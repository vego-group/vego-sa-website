...
function DeleteConfirmationPopup({ 
  ...
  return (
    <Modal
      ...
      contentClassName="bg-gradient-to-br from-primary via-primary to-emerald-950 sm:max-w-md w-[95vw] sm:w-[90vw] mx-auto"
    ...
    >
      <div className="space-y-4 sm:space-y-6 p-2 sm:p-4">
        ...
        <div className="bg-white/5 rounded-lg sm:rounded-2xl border border-white/10 p-4 sm:p-6 text-center">
          ...
          {articleTitle && (
            <p className="text-white font-medium text-sm sm:text-lg mb-3 sm:mb-4 break-words">
              "{articleTitle}"
            </p>
          )}
